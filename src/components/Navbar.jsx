...
const Navbar = ({setKeyword }) => {
  return (
    <nav className=" mb-5 backdrop-blur-xs w-full flex flex-col md:flex-row justify-between items-center ">
   
      <div className="flex gap-3 items-center mb-3 md:mb-0">
        <SiGamedeveloper size={28} className="text-gray-400" />
        <h1 className="text-xl md:text-xl font-bold">DevShowCase/Ranjan-builds</h1>
      </div>

      {/* Right Side */}
      <div className="flex gap-3 md:gap-5 items-center w-full md:w-auto justify-center">
